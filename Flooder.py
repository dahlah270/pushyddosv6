...
def banner():
 ...
 `:::::`::::::::::::;'`:;::#                O
   ...
   ::::::`:::::;'  /  /   `#            
     {random_phrase()}
    \033[2;33mVersion: V6 \t Coded by Pushy\n\033[0m
    """)
...
def DoS(ip, port, size, index):
    ...
    while True:
        ...
        print(f"\033[1;34m[THREAD {index}] \033[0m\xBB \033[1;35m{size}\033[0m @PushyGamertag37 Attack  ════>  to \033[1;35m{ip}\033[0m")
